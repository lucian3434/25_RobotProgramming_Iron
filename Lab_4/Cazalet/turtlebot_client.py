...
class TurtleClient(Node):
    def __init__(self):
        ...
        self.declare_parameter('turtleColor', 'blue', ParameterDescriptor(description='Default color of the turtle'))
        ...
        self.declare_parameter('penSize', 2,  ParameterDescriptor(description='Default pen size for the turtle')) 
