...
def generate_launch_description():
	...
	param_file = os.path.join(get_package_share_directory('yahboomcar_multi'),'param','X3_nav_robot2.yaml')
	...
	controller_node = Node(
        ...
        parameters=[os.path.join(get_package_share_directory('yahboomcar_multi'),'param','X3_nav_robot2.yaml')],
