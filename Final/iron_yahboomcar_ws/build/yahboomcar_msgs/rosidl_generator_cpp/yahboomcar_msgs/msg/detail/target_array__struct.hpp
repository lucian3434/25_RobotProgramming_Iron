...
struct TargetArray_
{
  ...
  using _data_type =
    std::vector<yahboomcar_msgs::msg::Target_<ContainerAllocator>, typename ContainerAllocator::template rebind<yahboomcar_msgs::msg::Target_<ContainerAllocator>>::other>;
  _data_type data;

  // setters for named parameter idiom
  Type & set__data(
    const std::vector<yahboomcar_msgs::msg::Target_<ContainerAllocator>, typename ContainerAllocator::template rebind<yahboomcar_msgs::msg::Target_<ContainerAllocator>>::other> & _arg)
  {
    this->data = _arg;
    return *this;
  }
