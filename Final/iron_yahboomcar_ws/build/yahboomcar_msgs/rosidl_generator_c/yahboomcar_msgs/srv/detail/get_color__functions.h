...
#ifndef YAHBOOMCAR_MSGS__SRV__DETAIL__GET_COLOR__FUNCTIONS_H_
#define YAHBOOMCAR_MSGS__SRV__DETAIL__GET_COLOR__FUNCTIONS_H_
...
/// Initialize srv/GetColor message.
/**
...
/// Create srv/GetColor message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * yahboomcar_msgs__srv__GetColor_Request__init().
...
/// Destroy srv/GetColor message.
/**
 * It calls
 * yahboomcar_msgs__srv__GetColor_Request__fini()
...
/// Check for srv/GetColor message equality.
/**
...
/// Initialize array of srv/GetColor messages.
/**
...
/// Finalize array of srv/GetColor messages.
/**
 * It calls
 * yahboomcar_msgs__srv__GetColor_Request__fini()
...
/// Create array of srv/GetColor messages.
/**
 * It allocates the memory for the array and calls
 * yahboomcar_msgs__srv__GetColor_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/GetColor messages.
/**
 * It calls
 * yahboomcar_msgs__srv__GetColor_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/GetColor message array equality.
/**
...
/// Copy an array of srv/GetColor messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * yahboomcar_msgs__srv__GetColor_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_yahboomcar_msgs
...
/**
 * It calls
 * yahboomcar_msgs__srv__GetColor_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_yahboomcar_msgs
...
/**
 * It allocates the memory for the array and calls
 * yahboomcar_msgs__srv__GetColor_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_yahboomcar_msgs
...
/**
 * It calls
 * yahboomcar_msgs__srv__GetColor_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // YAHBOOMCAR_MSGS__SRV__DETAIL__GET_COLOR__FUNCTIONS_H_
