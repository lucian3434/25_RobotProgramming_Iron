...
{
  return max_serialized_size_yahboom_web_savmap_interfaces__srv__WebSaveMap_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_yahboom_web_savmap_interfaces__srv__WebSaveMap_Response(
    full_bounded, 0);
}
