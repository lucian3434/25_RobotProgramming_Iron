...
#include "yahboom_web_savmap_interfaces/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _WebSaveMap_Request_type_support_symbol_names_t _WebSaveMap_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, yahboom_web_savmap_interfaces, srv, WebSaveMap_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, yahboom_web_savmap_interfaces, srv, WebSaveMap_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_yahboom_web_savmap_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, yahboom_web_savmap_interfaces, srv, WebSaveMap_Request)() {
  return &::yahboom_web_savmap_interfaces::srv::rosidl_typesupport_c::WebSaveMap_Request_message_type_support_handle;
}
...
static const _WebSaveMap_Response_type_support_symbol_names_t _WebSaveMap_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, yahboom_web_savmap_interfaces, srv, WebSaveMap_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, yahboom_web_savmap_interfaces, srv, WebSaveMap_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_yahboom_web_savmap_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, yahboom_web_savmap_interfaces, srv, WebSaveMap_Response)() {
  return &::yahboom_web_savmap_interfaces::srv::rosidl_typesupport_c::WebSaveMap_Response_message_type_support_handle;
}
...
static const _WebSaveMap_type_support_symbol_names_t _WebSaveMap_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, yahboom_web_savmap_interfaces, srv, WebSaveMap)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, yahboom_web_savmap_interfaces, srv, WebSaveMap)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, yahboom_web_savmap_interfaces, srv, WebSaveMap)() {
  return &::yahboom_web_savmap_interfaces::srv::rosidl_typesupport_c::WebSaveMap_service_type_support_handle;
}
